...
function [SCRPTipt,OB,err] = SimMeovPhanFlexible_v2b(SCRPTipt,OBipt)
...
OB.BigSphereMag = str2double(OBipt.('BigSphereMag'));
OB.MeovSphereMag = str2double(OBipt.('MeovSphereMag'));
