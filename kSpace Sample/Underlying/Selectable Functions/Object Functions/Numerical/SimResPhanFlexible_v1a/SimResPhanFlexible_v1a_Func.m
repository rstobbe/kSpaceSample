...
function [OB,err] = SimResPhanFlexible_v1a_Func(OB,INPUT)
...
OB.Ob = Ob;
OB.ObMatSz = M;
OB.name = ['SimResPhanD',num2str(OB.SphereDiam),'R',num2str(OB.ResDiam1*10),num2str(OB.ResDiam2*10),num2str(OB.ResDiam3*10),num2str(OB.ResDiam4*10),num2str(OB.ResDiam5*10)];
OB.plot = 'CentreSlice';
