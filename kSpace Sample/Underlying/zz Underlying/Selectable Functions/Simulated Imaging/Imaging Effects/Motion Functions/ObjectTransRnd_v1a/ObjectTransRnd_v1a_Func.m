...
function [TRANS,err] = ObjectTransRnd_v1a_Func(TRANS,INPUT)
...
%---------------------------------------------
% Random Translate values
%---------------------------------------------
transstdev = transstdev/sqrt(3);
translations = transstdev*randn(nproj,3);
translations(1,:) = 0;
